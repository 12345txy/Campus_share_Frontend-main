    ...
    <template v-if="$route.path != '/LoginRegister'">
      ...
      <v-navigation-drawer v-model="drawer" class="d-none d-sm-none d-md-flex " app>
        <v-list-item class="mt-12 d-flex flex-column">
          <v-list-item-content>
            <v-list-item-title style="font-weight: bold;font-size:40px;">游学系统</v-list-item-title>
      ...
      <v-list dense nav>
        <v-list-item v-for="item in menuItems" :key="item.title" :to="item.to" link class="align-center" mandatory color="indigo">
