                ...
                <div class="d-flex align-center mt-2">
                    ...
                    <div class="comment-actions d-flex align-center flex-wrap">
                        ...
                        <div class="d-flex align-center mr-3">
                            <v-btn icon x-small :color="comment.isLiked ? 'indigo' : 'grey'" class="mr-1"
                        ...
                        <div v-if="comment.replyCount > 0" class="d-flex align-center">
                            <v-btn x-small text color="blue" class="mr-1" @click="toggleShowReplies(comment)">
                                    ...
                                    <div class="d-flex align-center mt-2">
                                        ...
                                        <div class="comment-actions d-flex align-center">
                                            ...
                                            <div class="d-flex align-center">
                                                <v-btn icon x-small :color="reply.isLiked ? 'indigo' : 'grey'"
                                                    class="mr-1" @click.stop="toggleCommentLike(reply, $event)">
                                                    <v-icon small>{{ reply.isLiked ? 'mdi-thumb-up' :
